...
from func_analysis.analysis_rewriter_llm import rewrite_analysis_llm
from func_analysis.analysis_saver import save_analysis
from func_analysis.driver_aggregator import aggregate_driver_analyses
from func_analysis.analysis_input_formatter import build_material_for_section
...
def analysis_rewriter(topic_id: str, test: bool = False, analysis_type: Optional[str] = None) -> None:
    ...
    run_trk = Tracker("analysis_rewriter_run")
    ...
    for section in sections_to_run:
        ...
        sec_trk = Tracker("analysis_section_rewrite")
