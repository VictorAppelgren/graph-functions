...
from func_add_article.node_identifier_llm import find_node_mapping
from func_add_article.category_identifier_llm import find_category
from func_add_article.impact_identifier_llm import find_impact
...
from func_add_relationships.find_relationships import find_influences_and_correlates
from func_analysis.does_article_replace_old import does_article_replace_old
...
def add_article(article_id: str, test: bool = False, intended_topic_id: str | None = None) -> dict:
    ...
    if len(new_node_names) > 0:
        ...
        # Create new topic
        from func_add_topic.add_node import add_node
