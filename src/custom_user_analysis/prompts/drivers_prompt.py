...
1) 1+1=3 SYNTHESIS: Two articles together reveal scenarios neither shows alone. Ask: "What does Article A + Article B mean for {asset_name}'s future?" Identify compound effects, transmission chains, and non-obvious implications. THIS IS CRITICAL FOR DRIVERS SECTION—connect dots others miss.
...
9) RELATED ASSET INTELLIGENCE: When mentioning other assets, immediately state: "This affects {asset_name} by..." Show explicit transmission to {asset_name}. THIS IS THE CORE OF DRIVERS ANALYSIS.
